...
public class listadaptcari extends ArrayAdapter<String> {
    ...
    public listadaptcari(Activity context, String[] nis, String[] nama, String[] poin, String[] ket, String[] jenpel, String[] id){
        super(context, R.layout.activity_cari, nama);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        View r=convertView;
        listadaptcari.ViewHolder viewHolder=null;
        if(r==null){
            LayoutInflater layoutInflater=context.getLayoutInflater();
            r=layoutInflater.inflate(R.layout.activity_list_adapt, null,true);
            viewHolder=new listadaptcari.ViewHolder(r);
            r.setTag(viewHolder);
        }
        else {
            viewHolder=(listadaptcari.ViewHolder)r.getTag();
